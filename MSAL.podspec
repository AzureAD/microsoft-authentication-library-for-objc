Pod::Spec.new do |s|
  ...
  s.pod_target_xcconfig = { 'CLANG_WARN_OBJC_IMPLICIT_RETAIN_SELF' => 'NO', 'HEADER_SEARCH_PATHS' => "$(PODS_ROOT)/MSAL/app-lib"}
  s.default_subspecs ='app-lib'

  s.xcconfig  = { 'HEADER_SEARCH_PATHS' => "$(PODS_ROOT)/MSAL/app-lib" }
