Pod::Spec.new do |s|
  ...
  s.subspec 'app-lib' do |app|
  	...
  	app.ios.public_header_files = "MSAL/src/public/*.h","MSAL/src/public/ios/*.h", "MSAL/src/public/ios/**/*.h", "MSAL/src/public/configuration/**/*.h"
  ...
  s.subspec 'extension' do |ext|
  	...
  	ext.ios.public_header_files = "MSAL/src/public/*.h","MSAL/src/public/ios/*.h","MSAL/src/public/ios/**/*.h", "MSAL/src/public/configuration/**/*.h"
