...
typedef NS_ENUM(NSUInteger, YKFU2FErrorCode) {
     ...
     */
    YKFU2FErrorCodeU2FSigningUnavailable = 0x000010
};
...
/*!
 @class
    YKFU2FError
 @abstract
    Error type returned by the YKFU2FService.
 */
@interface YKFU2FError: YKFSessionError
@end
